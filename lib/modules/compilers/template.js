...
module.exports = TemplateCompiler = (function() {
  ...
  TemplateCompiler.prototype._merge = function(config, options, next) {
    var folder, found, libPath, mergedFiles, mergedText, outputFileConfig, prefix, suffix, _i, _j, _len, _len1, _ref, _ref1,
      _this = this;
    if (!options.isTemplateFile) {
      return next();
    }
    ...
    for (_i = 0, _len = _ref.length; _i < _len; _i++) {
      ...
      options.files.forEach(function(file) {
        ...
        for (_k = 0, _len2 = _ref2.length; _k < _len2; _k++) {
          folder = _ref2[_k];
          if (((_ref3 = file.inputFileName) != null ? _ref3.indexOf(path.join(folder, path.sep)) : void 0) === 0) {
            mergedFiles.push({
