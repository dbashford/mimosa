"use strict";
var compilerLib, determineBaseFiles, exec, fs, getImportFilePath, hasCompass, hasSASS, importRegex, init, isInclude, logger, path, prefix, runSass, setCompilerLib, spawn, _, __compileNode, __compileRuby, __doRubySASSChecking, __preCompileRubySASS, _ref;
...
prefix = function(file, config, options, done) {
  if (config.compilers.libs.sass) {
