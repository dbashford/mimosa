"use strict";
var CSSCompiler, CopyCompiler, JavaScriptCompiler, TemplateCompiler, compilers, fs, logger, path, templateLibrariesBeingUsed, _, _testDifferentTemplateLibraries;
...
exports.setupCompilers = function(config) {
  ...
  for (modName in _ref) {
    ...
    if (mod.compilerType) {
      ...
      compilers.push(mod);
      console.log("ADDED " + mod.name + " to compilers");
    }
  }
