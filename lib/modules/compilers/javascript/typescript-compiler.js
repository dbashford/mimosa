...
var TypeScript, compilationSettings, defaultLibPath, fs, io, logger, path, __setupTypeScript, _compile, _config, _init;
...
__setupTypeScript = function() {
  ...
  if (((_ref = _config.typescript) != null ? _ref.module : void 0) != null) {
    if (_config.typescript.module === "commonjs") {
      return TypeScript.moduleGenTarget = TypeScript.ModuleGenTarget.Synchronous;
    } else if (_config.typescript.module === "amd") {
