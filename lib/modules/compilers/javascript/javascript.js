...
module.exports = JSCompiler = (function() {
  function JSCompiler(config, extensions, compiler) {
  ...
  JSCompiler.prototype._compile = function(config, options, next) {
    ...
    return options.files.forEach(function(file) {
      if (logger.isDebug) {
        logger.debug("Calling compiler function for compiler [[ " + _this.compiler.base + " ]]");
      }
      return _this.compiler.compile(file, function(err, output, compiledConfig, sourceMap) {
