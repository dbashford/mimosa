"use strict";
var JSCompiler, fileUtils, fs, logger, path, _, _cleanUpSourceMaps, _genMapFileName, _genSourceName,
...
exports.cleanUpSourceMapsRegister = function(register, extensions, compilerConfig) {
...
exports.JSCompiler = JSCompiler = (function() {
  ...
  JSCompiler.prototype._compilerLib = function(config, options, next) {
    if (this.delayedCompilerLib) {
      this.compilerLib = require(this.libName);
