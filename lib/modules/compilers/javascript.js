"use strict";
var JSCompiler, deprecateMessageShown, logger, __sourceMap, _determineOutputFile,
...
_determineOutputFile = function(config, options, next) {
...
__sourceMap = function(file, output, sourceMap) {
...
module.exports = JSCompiler = (function() {
  ...
  JSCompiler.prototype.registration = function(config, register) {
    ...
    register(['add', 'update', 'remove', 'cleanFile', 'buildFile'], 'init', _determineOutputFile, exts);
  ...
  JSCompiler.prototype._compile = function(config, options, next) {
    ...
    return options.files.forEach(function(file, i) {
      ...
      return _this.compiler.compile(config, file, function(err, output, sourceMap, deprecated) {
        if (arguments.length === 4) {
          if (!deprecateMessageShown) {
            logger.info(_this.compiler.name + " compiler is using deprecated compile return, please notify module author.");
