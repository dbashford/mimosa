"use strict";
var compile, compiler, compilerLib, config, ember, emberBoilerplate, fs, handlebars, init, libName, logger, path, prefix, regularBoilerplate, setCompilerLib, suffix, __boilerplate, __determineHandlebars, __transformTemplate;
...
__transformTemplate = function(text) {
...
compile = function(file, cb, handlebars, ember) {
