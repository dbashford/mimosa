"use strict";
var compile, compiler, compilerLib, config, ember, emberBoilerplate, fs, handlebars, init, libName, logger, path, prefix, regularBoilerplate, setCompilerLib, suffix, __determineHandlebars;
