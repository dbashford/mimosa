"use strict";
var TemplateCompiler, err, fileUtils, fs, logger, path, requireRegister, _,
...
module.exports = TemplateCompiler = (function() {
  function TemplateCompiler(config) {
    ...
    if (this.clientLibrary != null) {
      ...
      this.clientPath = path.join(jsDir, 'vendor', "" + this.clientLibrary + ".js");
    }
  }
    ...
    return options.files.forEach(function(file) {
      ...
      return _this.compile(file, function(err, result) {
        ...
        if (++i === options.files.length) {
          if (config.isVirgin && options.files.length === newFiles.length) {
  ...
  TemplateCompiler.prototype.__generateTemplateName = function(fileName, config) {
    var filePath, fullJSDir, nameTransform, returnFilepath;
  ...
  TemplateCompiler.prototype.libraryPath = function() {
    ...
    libPath = "vendor/" + this.clientLibrary;
    return (_ref = requireRegister != null ? requireRegister.aliasForPath(libPath) : void 0) != null ? _ref : libPath;
  };
