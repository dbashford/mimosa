...
module.exports = HandlebarsCompiler = (function(_super) {
  ...
  HandlebarsCompiler.prototype.determineHandlebars = function(mimosaConfig) {
    var ec, hbs;
    this.ember = mimosaConfig.template.handlebars.ember.enabled;
    hbs = mimosaConfig.compilers.libs.handlebars ? mimosaConfig.compilers.libs.handlebars : require('handlebars');
    return this.handlebars = this.ember ? (this.clientLibrary = null, ec = require('./resources/ember-comp'), ec.makeHandlebars(hbs)) : hbs;
  };
