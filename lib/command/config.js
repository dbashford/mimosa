var buildConfig, copyConfig, fs, logger, moduleManager, path, register;
...
copyConfig = function(opts) {
  var conf, currDefaultsPath, defaultsConf, mimosaConfigPath, mimosaConfigPathCoffee, modArray, modObj, outConfigText;
  if (opts.mdebug) {
    opts.debug = true;
    logger.setDebug();
  ...
  defaultsConf = "# The following is a commented version of the mimosa-config with all of\n# the defaults listed. This file is meant for reference only.\n\n" + conf;
