var NewCommand, buildConfig, deps, exec, fs, logger, path, util, wrench, _,
...
NewCommand = (function() {
  ...
  NewCommand.prototype["new"] = function(name, opts) {
    ...
    return util.projectPossibilities(function(compilers) {
      if (opts.defaults) {
  ...
  NewCommand.prototype._create = function(name, chosen) {
    ...
    this.skeletonPath = path.join(__dirname, '..', '..', 'skeleton', 'project');
