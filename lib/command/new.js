var compilers, copyCompilerSpecificExampleFiles, create, createWithDefaults, deps, devDependencies, exec, fs, isSystemPath, logger, makeChosenCompilerChanges, makeServerChanges, modifyBowerJSONName, moduleManager, moveDirectoryContents, moveViews, newProject, outConfig, packageJson, path, printHelp, program, projectName, prompting, register, runNPMInstall, servers, setupData, setupPackageJSON, skeletonOutPath, updateConfigForChosenCompilers, usingDefaultServer, usingNoServer, usingOwnServer, views, windowsDrive, wrench, writeConfigs, _;
