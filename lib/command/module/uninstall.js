...
register = function(program, callback) {
  var _this = this;
  return program.command('mod:uninstall [name]').option("-D, --debug", "run in debug mode").description("uninstall a Mimosa module from your installed Mimosa").action(callback).on('--help', function() {
