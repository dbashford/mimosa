...
install = function(name, opts) {
  var currentDir, dirName, err, exec, fs, logger, mimosaPath, pack, packPath, path, wrench, _doLocalInstall, _doNPMInstall, _doneNPMInstall, _installModule, _prepareForNPMInstall, _revertInstall, _testLocalInstall;
  path = require('path');
  fs = require('fs');
