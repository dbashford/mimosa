...
register = function(program, callback) {
  var _this = this;
  return program.command('mod:install [name]').option("-D, --debug", "run in debug mode").description("install a Mimosa module into your Mimosa").action(callback).on('--help', function() {
